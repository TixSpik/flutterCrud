...
class RegisterPage extends StatelessWidget {
  ...
  _register(LoginBloc bloc, BuildContext ctx) async {
    print('Email Registro: ${bloc.email}');
    print('Password Registro: ${bloc.password}');
    final Map info = await userProvider.newUser(bloc.email, bloc.password);

    if (info['ok']) {
      await userProvider.authUser(info['email'], info['password']);
